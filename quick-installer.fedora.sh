...
# Fedora Web Shell Installer
# This script installs and configures the Fedora Web Shell application

#########################################################################################################################################################
# Usage: 
# wget https://raw.githubusercontent.com/QinCai-rui/rpi-web-shell/refs/heads/main/quick-installer-fedora.sh && chmod +x quick-installer-fedora.sh && alias sudo='sudo'
# export USERNAME=$(whoami) && sudo -E ./quick-installer-fedora.sh
#########################################################################################################################################################
set -e
...
print_green "========================================"
print_green "      Fedora Web Shell Installer"
print_green "========================================"
echo ""
...
command -v git >/dev/null 2>&1 || { print_red "git is required but not installed. Installing git..."; dnf -y install git; }
command -v python3 >/dev/null 2>&1 || { print_red "python3 is required but not installed. Installing python3..."; dnf -y install python3 python3-virtualenv; }

# Ask for custom port number
echo ""
read -p "Enter port number for Web Shell [default: 5001]: " custom_port
...
print_yellow "Cloning the Web Shell repository..."
...
print_yellow "Enabling and starting Web Shell service..."
systemctl daemon-reload
systemctl enable --now rpi-shell

# Check if service started successfully
if systemctl is-active --quiet rpi-shell; then
    print_green "Web Shell service started successfully!"
else
    print_red "Failed to start Web Shell service. Check logs with 'journalctl -u rpi-shell'"
fi
...
print_green "========================================"
echo ""
print_green "Web Shell has been installed successfully."
echo ""
...
print_green "Thank you for installing Web Shell!"
